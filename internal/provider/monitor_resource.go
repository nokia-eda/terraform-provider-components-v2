...
const (
	create_rs_monitor = "/apps/components.eda.nokia.com/v2/namespaces/{namespace}/monitors"
	read_rs_monitor   = "/apps/components.eda.nokia.com/v2/namespaces/{namespace}/monitors/{name}"
	update_rs_monitor = "/apps/components.eda.nokia.com/v2/namespaces/{namespace}/monitors/{name}"
	delete_rs_monitor = "/apps/components.eda.nokia.com/v2/namespaces/{namespace}/monitors/{name}"
)
